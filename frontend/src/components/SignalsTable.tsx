  ...
  return (
    <div className="bg-[#1a1d2e] rounded-lg border border-slate-800">
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-slate-800 text-slate-600 text-xs uppercase tracking-wider">
              ...
              <th className="px-4 py-2 text-left font-medium hidden sm:table-cell" title="RSI: below 40 = oversold (cheap), above 70 = overbought (expensive)">Momentum</th>
              <th className="px-4 py-2 text-left font-medium hidden sm:table-cell" title="Is the stock above its 200-day average? Up = healthy trend, Down = broken">Trend</th>
      ...
      <div className="px-4 py-2 border-t border-slate-800 text-xs text-slate-600 flex flex-wrap gap-x-4 gap-y-1">
        ...
        <span>Momentum: &lt;40 oversold · &gt;70 overbought</span>
        <span>Health grade: A = strong · B = good · C = weak · D = avoid</span>
